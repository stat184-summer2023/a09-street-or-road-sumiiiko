...
My answer here.......
Line 1: "(NSCU)" is assigned to patterns
Line 2: Test is assigned to the result of the code below
Line 3: Addresses data is access through a pipe
Line 4: filters out the addresses that contains "NSCU". The grepl allows for pattern matching. 
Line 5: filters out the addresses that does not RD or ROAD 
...
Test %>% 
  ...
  head(10) %>%
  ggplot(aes(x = reorder(address, -popularity), y = popularity)) +
...
My answer here.......
In the top ten most common street name, the highest count of street name was 10 and the lowest count were below 2.5.  
